...
var _allComponents = __webpack_require__(27);

var _allComponents2 = _interopRequireDefault(_allComponents);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_allComponents2.default, null), document.getElementById('app'));
...
var _openPopup = __webpack_require__(28);
...
var _calculator = __webpack_require__(37);
...
var AllComponents = function AllComponents() {
	return _react2.default.createElement(
		...
		_react2.default.createElement(_openPopup2.default, null),
		_react2.default.createElement('hr', null),
		_react2.default.createElement(
			'h2',
			null,
...
var OpenPopup = function (_React$Component) {
	_inherits(OpenPopup, _React$Component);

	function OpenPopup() {
		_classCallCheck(this, OpenPopup);

		var _this = _possibleConstructorReturn(this, (OpenPopup.__proto__ || Object.getPrototypeOf(OpenPopup)).call(this));
		...
		_this.openPopupFunction = _this.openPopupFunction.bind(_this);

		return _this;
	}

	_createClass(OpenPopup, [{
		key: 'changeText',
		...
		key: 'openPopupFunction',
		value: function openPopupFunction() {
		...
		value: function render() {
			if (this.state.isPopupOpened) {
				return _react2.default.createElement(_popup2.default, { text: this.state.text, color: this.state.color, functionClose: this.openPopupFunction });
			} else {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('input', { type: 'text', placeholder: 'Insert your text', value: this.state.text, onChange: this.changeText }),
					_react2.default.createElement('input', { type: 'color', value: this.state.color, onChange: this.changeColor }),
					_react2.default.createElement(
						'button',
	...
	_createClass(Popup, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"div",
					{ className: "popup", style: { 'backgroundColor': color } },
					_react2.default.createElement(
						"p",
						null,
						text
...
var _textContent = __webpack_require__(32);
	...
	_createClass(Counter, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'counter' },
				_react2.default.createElement(_textContent2.default, { text: this.state.number }),
				_react2.default.createElement(
					'button',
	...
	_createClass(TextContent, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'span',
					{ className: text < 0 ? 'red-color' : 'green-color' },
					' ',
					text,
					' '
				)
...
var _cellColor = __webpack_require__(34);
...
var ColorPicker = function (_React$Component) {
	...
	function ColorPicker() {
		...
		_this.state = {
			colorsList: ['red', 'lime', 'blue', 'orange', 'purple', 'yellow', 'white', 'silver', 'deeppink'],
			currentColor: 'red'
		};
		return _this;
	}
	...
	_createClass(ColorPicker, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'box-with-colors' },
					this.state.colorsList.map(function (color, index) {
						return _react2.default.createElement(
							'div',
							{ key: index, onClick: function onClick() {
									_this2.changeColor(color);
								} },
							_react2.default.createElement(_cellColor2.default, { key: index, color: color })
						);
					})
				),
				_react2.default.createElement('div', { className: 'colorful-box', style: { 'background': this.state.currentColor } })
			);
		}
	}]);
...
var CellColor = function CellColor(_ref) {
	...
	return _react2.default.createElement('div', { className: 'cell-color', style: { 'background': color }
	});
};
...
var _timerContent = __webpack_require__(36);

var _timerContent2 = _interopRequireDefault(_timerContent);
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'timer-box' },
					_react2.default.createElement(_timerContent2.default, { text: this.state.time })
				)
			);
		}
	}]);
...
var TimerContent = function (_React$Component) {
	_inherits(TimerContent, _React$Component);

	function TimerContent() {
		_classCallCheck(this, TimerContent);

		return _possibleConstructorReturn(this, (TimerContent.__proto__ || Object.getPrototypeOf(TimerContent)).apply(this, arguments));
	}

	_createClass(TimerContent, [{
		key: 'render',
		value: function render() {
			var text = this.props.text;
			...
			if (text > 0) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'span',
						{ className: text < 6 ? 'red-color' : 'green-color' },
						' ',
						text,
						' '
					)
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('img', { src: 'https://usadultliteracy.files.wordpress.com/2012/06/bang1.png' })
					)
				);
			}
		}
...
var Calculator = function (_React$Component) {
	...
	_createClass(Calculator, [{
		key: 'changeNumber',
		value: function changeNumber(number) {
			var newNumber = '';
		...
		key: 'clearActions',
		value: function clearActions(index) {
			switch (index) {
				case 0:
					var str = String(this.state.currentNumber);
		...
		key: 'signActions',
		value: function signActions(index) {
			var buferNumber = parseFloat(this.state.currentNumber);
			var buferIndex = index;
			switch (index) {
				case 0:
					if (buferNumber > 0) {
						this.setState({
		...
		value: function count() {
			var position = this.state.currentNumber.lastIndexOf(' ');
			var secondArg = parseFloat(this.state.currentNumber.substring(position + 1));
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'clear-btns' },
						this.state.clearBtns.map(function (clearBtn, index) {
							return _react2.default.createElement(
								'div',
								{ className: 'calc-btn', key: index },
								_react2.default.createElement(
									'button',
									{ onClick: function onClick() {
											_this2.clearActions(index);
										} },
									clearBtn
								)
							);
				...
				_react2.default.createElement(
					'div',
					{ className: 'signs-box' },
					this.state.signs.map(function (sign, index) {
						return _react2.default.createElement(
							'div',
							{ className: 'calc-btn', key: index },
							_react2.default.createElement(
